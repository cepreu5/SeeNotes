...
const translations = {
    en: {
        ...
        notesBgrdLabel: 'Graphical background (notes list):',
        imgBgrdLabel: 'Graphical background (single note):',
    ...
    bg: {
        ...
        notesBgrdLabel: 'Графичен фон (списък бележки):',
        imgBgrdLabel: 'Графичен фон (единична бележка):',
