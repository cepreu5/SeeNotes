...
const translations = {
    en: {
        ...
        calendar: 'Calendar',
        calendarButtonTooltip: 'Calendar',
        ...
        confirmConfigDelete: 'Delete additional data as well? (data for user, etc.)',
        ...
        confirmNoteDelete: 'Are you sure you want to delete this note from the database? This will not delete it from the data source (e.g. Google Drive).',
        ...
        showBoardAll: 'Show board <strong><i>All</i></strong>:',
        allBoards: 'All',
        showBoardRemind: 'Show board <strong><i>Reminders</i></strong>:',
        reminder: 'Reminders',
        showPhotosBoardLabel: 'Board <strong><i>With Photos</i></strong>:',
        photosBoardTitle: 'With Photos',
        showVideosBoardLabel: 'Board <strong><i>With Video</i></strong>:',
        videosBoardTitle: 'With Video',
        showSoundsBoardLabel: 'Board <strong><i>With Sounds</i></strong>:',
        soundsBoardTitle: 'With Sounds',
        showOtherBoardLabel: 'Board <strong><i>Other Attachments</i></strong>:',
        otherBoardTitle: 'Other Attachments',
        oneTapLinkLabel: 'One-click links:',
        hideAssistantLabel: 'Hide Assistant:',
        notesBgrdLabel: 'Graphical background (board notes):',
        imgBgrdLabel: 'Graphical background (note):',
        ...
        intro1: '<strong>CX MultiNotes Viewer</strong> is a browser-based application that allows you to access the information in notes created with the <a href="https://play.google.com/store/apps/details?id=monitor.kmv.multinotes" target="_blank"><strong>Multinotes app for Android</strong></a>, from your computer, tablet, iPhone, etc., regardless of whether you are working with Windows, Android, macOS, iOS, or Linux.',
        ...
        invalidCertificate: 'Invalid or expired certificate!<br><br>Невалиден или изтекъл сертификат!',
    ...
    bg: {
        ...
        sortByNumber: 'по пореден номер',
        sortByColor: 'по цвят',
        sortByCreationDate: 'по дата на създаване',
        sortByModificationDate: 'по дата на промяна',
        ...
        calendar: 'Календар',
        calendarButtonTooltip: 'Календар',
        ...
        confirmConfigDelete: 'Да се изтрият ли и служебните данни? (данни за потребител и др.)',
        ...
        confirmNoteDelete: 'Сигурни ли сте, че искате да изтриете тази бележка от базата данни? Това няма да я изтрие от източника (напр. Google Drive).',
        ...
        showBoardAll: 'Борд <strong><i>Всички</i></strong>:',
        allBoards: 'Всички',
        showBoardRemind: 'Борд <strong><i>Напомняния</i></strong>:',
        reminder: 'Напомняния',
        showPhotosBoardLabel: 'Борд <strong><i>Със снимки</i></strong>:',
        photosBoardTitle: 'Със снимки',
        showVideosBoardLabel: 'Борд <strong><i>С видео</i></strong>:',
        videosBoardTitle: 'С видео',
        showSoundsBoardLabel: 'Борд <strong><i>Със звук</i></strong>:',
        soundsBoardTitle: 'Със звук',
        showOtherBoardLabel: 'Борд <strong><i>Други приложения</i></strong>:',
        otherBoardTitle: 'Други приложения',
        oneTapLinkLabel: 'Линкове с един клик:',
        hideAssistantLabel: 'Скриване на асистента:',
        notesBgrdLabel: 'Графичен фон (бележки в борда):',
        imgBgrdLabel: 'Графичен фон (бележка):',
        ...
        intro1: '<strong>CX MultiNotes Viewer</strong> е приложение, работещо в браузъра ви, чрез което може да имате достъп до информацията в бележките, създадени с приложението <a href="https://play.google.com/store/apps/details?id=monitor.kmv.multinotes" target="_blank"><strong>Multinotes за Андроид</strong></a>, от вашия компютър, таблет, iPhone и др., независимо дали работите с Windows, Android, macOS, iOS или Linux.',
        ...
        invalidCertificate: 'Невалиден или изтекъл сертификат!<br><br>Invalid or expired certificate!',
